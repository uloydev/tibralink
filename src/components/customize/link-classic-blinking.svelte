...
<div class="modal-box w-11/12 !max-w-4xl">
    ...
    <div class="modal-action">
        <form method="post" class="flex w-full flex-col gap-y-2" enctype="multipart/form-data" action="?/customize" use:enhance={() => {
            ...
            <!-- blink inputs -->
            <fieldset class="fieldset w-full">
                <legend class="fieldset-legend text-sm">Blink Text</legend>
                <input
                    name="blinkText"
                    required
                    type="text"
                    class="input w-full"
                    value={customization?.blinkText}
                />
            </fieldset>
            <fieldset class="fieldset w-full">
            ...
            <fieldset class="fieldset w-full">
                <legend class="fieldset-legend text-sm">Blink Border Color</legend>
                <input
                    name="blink[borderColor]"
                    required
                    type="color"
                    class="input w-full"
                    placeholder="Type here"
                    value={customization?.blink?.borderColor}
                />
            </fieldset>
